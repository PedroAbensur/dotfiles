...
while (True):
    ...
    if(cons == '7'):
        ...
        try:
            ...
            consulta = "SELECT review.customer_id, p.product_group, COUNT(*) as num_reviews "
            consulta += "FROM review "
            consulta += "INNER JOIN product p ON review.asin_product = p.asin "
            consulta += "GROUP BY review.customer_id, p.product_group "
