...
while (True):
    ...
    if(cons == '3'):
        ...
        try:
            ...
            consulta = f"SELECT review_date, AVG(rating) as avg FROM (SELECT * FROM review WHERE asin_prod = '{asin}') as aux GROUP BY review_date ORDER BY review ASC"
            cur.execute(consulta)
    ...
    if(cons == '4'):
        ...
        try:
            ...
            consulta += "UNION (SELECT * from product where product_group='CE' order by salesrank LIMIT 10) order by group, rank DESC"
