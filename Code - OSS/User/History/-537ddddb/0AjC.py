...
while (True):
    ...
    if(cons == '3'):
        ...
        try:
            ...
            consulta = f"SELECT review_date, AVG(rating) as avg FROM (SELECT * FROM review WHERE review.asin_product = '{asin}') as aux GROUP BY review.review_date ORDER BY review ASC"
            cur.execute(consulta)
